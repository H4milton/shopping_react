...
Esta es una aplicación simple de carrito de compras construida con Next.js, React y Zustand. Permite a los usuarios explorar productos, agregarlos a un carrito y simular la confirmación de un pedido.
